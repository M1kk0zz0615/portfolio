  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-shrink-0 md:mt-16 md:max-w-[62cqw] lg:mt-24 lg:ml-[34px] lg:max-w-[62cqw] xl:-ml-8">
          <AboutPosterTitle />
          ...
          <div className="anim-y-60 d-3 mt-6 flex justify-start md:mt-14 md:ml-2 lg:mt-14 lg:ml-auto">
            <AboutArchiveButton />
          </div>
        </div>
