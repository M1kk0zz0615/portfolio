  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden relative z-10 flex w-full flex-col px-4 pt-8 sm:px-8 sm:pt-12" style={{gap:"clamp(1rem, 3vh, 2.5rem)"}}>
        ...
        {/* 超大编号水印 */}
        <div className="absolute z-[1] select-none pointer-events-none" style={{right:"4%",bottom:"4%",fontSize:"clamp(8rem,40vw,20rem)",fontWeight:900,color:"var(--fg)",opacity:.04,lineHeight:.85,letterSpacing:"-0.05em",fontFamily:"var(--font-geist-mono)"}} aria-hidden="true">04</div>
      </div>
    </section>
  );
}
